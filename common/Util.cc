...
char* Util::strToCharStar(const std::string & str) {
    return const_cast<char*>(str.c_str());
}

// sep 是分割符，默认是空格分割
// maxsplit 代表最大分割次数，-1是
void Util::split(const std::string& str, std::vector<std::string>& result, const std::string& sep, int maxsplit) {
    result.clear();
...
void Util::split_whitespace(const std::string& str, std::vector<std::string>& result, int maxsplit) {
